...
HEADLINE_MAX_LEN = 100  # ФИКС: было 55 — резало заголовок на середине мысли
                        # ("...стали объектом…"). 100 символов почти всегда
                        # достаточно, чтобы уместить законченное предложение;
                        # это теперь редкий аварийный лимит, а не рабочий режим.
